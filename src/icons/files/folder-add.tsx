/* GENERATED from icons/round-outline/files/folder-add.svg, icons/round-solid/files/folder-add.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function FolderAdd({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_7962)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6741)">
        <path d="M12.0601 17.25C11.6501 17.25 11.3101 16.91 11.3101 16.5V11.5C11.3101 11.09 11.6501 10.75 12.0601 10.75C12.4701 10.75 12.8101 11.09 12.8101 11.5V16.5C12.8101 16.91 12.4701 17.25 12.0601 17.25Z" fill="currentColor"/>
