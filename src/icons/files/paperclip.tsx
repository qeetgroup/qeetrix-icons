/* GENERATED by scripts/generate.mjs from icons/outline/files/paperclip.svg, icons/solid/files/paperclip.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Paperclip({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
