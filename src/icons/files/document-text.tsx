/* GENERATED by scripts/generate.mjs from icons/outline/files/document-text.svg, icons/solid/files/document-text.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function DocumentText({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
