/* GENERATED from icons/outline/files/document-text.svg, icons/solid/files/document-text.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function DocumentText({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
