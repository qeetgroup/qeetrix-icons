/* GENERATED from icons/round-outline/files/folder-cross.svg, icons/round-solid/files/folder-cross.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function FolderCross({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_7960)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6738)">
        <path d="M13.81 16.4799C13.62 16.4799 13.43 16.4099 13.28 16.2599L9.73996 12.7199C9.44996 12.4299 9.44996 11.9499 9.73996 11.6599C10.03 11.3699 10.51 11.3699 10.8 11.6599L14.34 15.1999C14.63 15.4899 14.63 15.9699 14.34 16.2599C14.19 16.3999 14 16.4799 13.81 16.4799Z" fill="currentColor"/>
