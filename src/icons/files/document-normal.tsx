/* GENERATED from icons/round-outline/files/document-normal.svg, icons/round-solid/files/document-normal.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function DocumentNormal({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
