/* GENERATED by scripts/generate.mjs from icons/outline/files/folder-connection.svg, icons/solid/files/folder-connection.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function FolderConnection({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
