/* GENERATED by scripts/generate.mjs from icons/outline/communication/voice-square.svg, icons/solid/communication/voice-square.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function VoiceSquare({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
