/* GENERATED from icons/round-outline/communication/sms-notification.svg, icons/round-solid/communication/sms-notification.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function SmsNotification({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
