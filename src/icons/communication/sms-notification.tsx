/* GENERATED by scripts/generate.mjs from icons/outline/communication/sms-notification.svg, icons/solid/communication/sms-notification.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SmsNotification({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
