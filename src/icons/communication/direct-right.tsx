/* GENERATED from icons/round-outline/communication/direct-right.svg, icons/round-solid/communication/direct-right.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function DirectRight({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
