/* GENERATED by scripts/generate.mjs from icons/outline/communication/direct-notification.svg, icons/solid/communication/direct-notification.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function DirectNotification({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
