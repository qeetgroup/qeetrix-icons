/* GENERATED by scripts/generate.mjs from icons/outline/communication/sms-tracking.svg, icons/solid/communication/sms-tracking.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SmsTracking({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
