/* GENERATED from icons/outline/communication/chatbox.svg, icons/solid/communication/chatbox.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Chatbox({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
