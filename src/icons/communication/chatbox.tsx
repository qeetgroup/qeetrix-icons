/* GENERATED by scripts/generate.mjs from icons/outline/communication/chatbox.svg, icons/solid/communication/chatbox.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Chatbox({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
