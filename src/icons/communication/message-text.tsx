/* GENERATED from icons/round-outline/communication/message-text.svg, icons/round-solid/communication/message-text.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MessageText({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
