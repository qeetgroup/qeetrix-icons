/* GENERATED by scripts/generate.mjs from icons/outline/communication/message-text.svg, icons/solid/communication/message-text.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MessageText({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
