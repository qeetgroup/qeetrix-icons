/* GENERATED from icons/outline/communication/sms-search.svg, icons/solid/communication/sms-search.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function SmsSearch({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
