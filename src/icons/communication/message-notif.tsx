/* GENERATED from icons/round-outline/communication/message-notif.svg, icons/round-solid/communication/message-notif.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MessageNotif({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
