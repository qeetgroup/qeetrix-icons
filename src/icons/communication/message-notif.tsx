/* GENERATED by scripts/generate.mjs from icons/outline/communication/message-notif.svg, icons/solid/communication/message-notif.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MessageNotif({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
