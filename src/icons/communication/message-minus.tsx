/* GENERATED from icons/round-outline/communication/message-minus.svg, icons/round-solid/communication/message-minus.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MessageMinus({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
