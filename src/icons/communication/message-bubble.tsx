/* GENERATED by scripts/generate.mjs from icons/outline/communication/message-bubble.svg, icons/solid/communication/message-bubble.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MessageBubble({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
