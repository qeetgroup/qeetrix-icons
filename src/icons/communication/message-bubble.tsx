/* GENERATED from icons/round-outline/communication/message-bubble.svg, icons/round-solid/communication/message-bubble.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MessageBubble({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
