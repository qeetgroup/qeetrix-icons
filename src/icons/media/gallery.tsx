/* GENERATED from icons/round-outline/media/gallery.svg, icons/round-solid/media/gallery.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Gallery({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8019)">
          <path d="M2.58005 19.0103L2.56005 19.0303C2.29005 18.4403 2.12005 17.7703 2.05005 17.0303C2.12005 17.7603 2.31005 18.4203 2.58005 19.0103Z" fill="currentColor"/>
