/* GENERATED by scripts/generate.mjs from icons/outline/media/video-horizontal.svg, icons/solid/media/video-horizontal.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function VideoHorizontal({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M11.25 7.86035H2V16.1904C2 16.2504 2 16.3104 2.01 16.3604H11.25V7.86035Z"
          fill="currentColor"
        />
        <path
        ...
        />
        <path
          d="M6.21988 6.24016V2.16016C3.99988 2.62016 2.54988 4.10016 2.12988 6.36016H6.23988C6.22988 6.32016 6.21988 6.28016 6.21988 6.24016Z"
          fill="currentColor"
        />
        <path d="M16.22 2H12.75V6.36H16.22V2Z" fill="currentColor" />
        <path
          d="M17.71 6.36039H21.87C21.45 4.08039 19.98 2.59039 17.72 2.15039V6.33039C17.72 6.34039 17.71 6.35039 17.71 6.36039Z"
          fill="currentColor"
        />
        <path
          d="M17.72 21.8504C19.91 21.4204 21.35 20.0204 21.82 17.8604H17.72V21.8504Z"
          fill="currentColor"
        />
        <path d="M16.22 17.8604H12.75V22.0004H16.22V17.8604Z" fill="currentColor" />
        <path
          d="M12.75 16.3604H21.99C22 16.3104 22 16.2504 22 16.1904V7.86035H12.75V16.3604Z"
          fill="currentColor"
        />
        <path d="M11.25 17.8604H7.71997V22.0004H11.25V17.8604Z" fill="currentColor" />
        <path
          d="M2.17993 17.8604C2.64993 20.0004 4.06993 21.4004 6.21993 21.8404V17.8604H2.17993Z"
          fill="currentColor"
        />
      </IconBase>
    );
