/* GENERATED from icons/round-outline/media/radio.svg, icons/round-solid/media/radio.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Radio({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6816)">
        ...
        <path d="M7 5.75C6.59 5.75 6.25 5.41 6.25 5V2C6.25 1.59 6.59 1.25 7 1.25C7.41 1.25 7.75 1.59 7.75 2V5C7.75 5.41 7.41 5.75 7 5.75Z" fill="currentColor"/>
        ...
        <path d="M18.5 11.75H14.5C14.09 11.75 13.75 11.41 13.75 11C13.75 10.59 14.09 10.25 14.5 10.25H18.5C18.91 10.25 19.25 10.59 19.25 11C19.25 11.41 18.91 11.75 18.5 11.75Z" fill="currentColor"/>
        <path d="M15 15.75H14.5C14.09 15.75 13.75 15.41 13.75 15C13.75 14.59 14.09 14.25 14.5 14.25H15C15.41 14.25 15.75 14.59 15.75 15C15.75 15.41 15.41 15.75 15 15.75Z" fill="currentColor"/>
        <path d="M18.5 15.75H18C17.59 15.75 17.25 15.41 17.25 15C17.25 14.59 17.59 14.25 18 14.25H18.5C18.91 14.25 19.25 14.59 19.25 15C19.25 15.41 18.91 15.75 18.5 15.75Z" fill="currentColor"/>
      </g>
      <defs>
