/* GENERATED from icons/round-outline/media/play.svg, icons/round-solid/media/play.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Play({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8029)">
          ...
          <path d="M18.0901 15.4596L14.0401 17.7996L10.0001 20.1296C8.55005 20.9596 6.91005 20.7896 5.72005 19.9496C5.14005 19.5496 5.21006 18.6596 5.82006 18.2996L18.5301 10.6796C19.1301 10.3196 19.9201 10.6596 20.0301 11.3496C20.2801 12.8996 19.6401 14.5696 18.0901 15.4596Z" fill="currentColor"/>
        </g>
        <defs>
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6762)">
