/* GENERATED from icons/round-outline/media/screenmirroring.svg, icons/round-solid/media/screenmirroring.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Screenmirroring({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
