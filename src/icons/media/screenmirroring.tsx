/* GENERATED by scripts/generate.mjs from icons/outline/media/screenmirroring.svg, icons/solid/media/screenmirroring.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Screenmirroring({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
