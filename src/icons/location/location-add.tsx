/* GENERATED by scripts/generate.mjs from icons/outline/location/location-add.svg, icons/solid/location/location-add.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function LocationAdd({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
