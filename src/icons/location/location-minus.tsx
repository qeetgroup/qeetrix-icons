/* GENERATED by scripts/generate.mjs from icons/outline/location/location-minus.svg, icons/solid/location/location-minus.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function LocationMinus({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
