/* GENERATED from icons/outline/location/location-tick.svg, icons/solid/location/location-tick.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function LocationTick({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
