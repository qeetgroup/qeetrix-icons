/* GENERATED from icons/round-outline/location/location.svg, icons/round-solid/location/location.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Location({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
