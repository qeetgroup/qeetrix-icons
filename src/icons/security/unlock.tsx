/* GENERATED from icons/outline/security/unlock.svg, icons/solid/security/unlock.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Unlock({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
