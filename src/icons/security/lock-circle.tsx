/* GENERATED by scripts/generate.mjs from icons/outline/security/lock-circle.svg, icons/solid/security/lock-circle.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function LockCircle({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M11.9999 15.1004C12.6074 15.1004 13.0999 14.6079 13.0999 14.0004C13.0999 13.3929 12.6074 12.9004 11.9999 12.9004C11.3924 12.9004 10.8999 13.3929 10.8999 14.0004C10.8999 14.6079 11.3924 15.1004 11.9999 15.1004Z"
          fill="currentColor"
        />
        <path
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M11.9999 15.3504C11.2599 15.3504 10.6499 14.7404 10.6499 14.0004C10.6499 13.2604 11.2599 12.6504 11.9999 12.6504C12.7399 12.6504 13.3499 13.2604 13.3499 14.0004C13.3499 14.7404 12.7399 15.3504 11.9999 15.3504ZM11.9999 13.8504C11.9199 13.8504 11.8499 13.9204 11.8499 14.0004C11.8499 14.1704 12.1499 14.1704 12.1499 14.0004C12.1499 13.9204 12.0799 13.8504 11.9999 13.8504Z"
        fill="currentColor"
      />
      <path
