/* GENERATED by scripts/generate.mjs from icons/outline/security/keyboard.svg, icons/solid/security/keyboard.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Keyboard({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
