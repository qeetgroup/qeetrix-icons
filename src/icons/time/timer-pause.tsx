/* GENERATED by scripts/generate.mjs from icons/outline/time/timer-pause.svg, icons/solid/time/timer-pause.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function TimerPause({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
