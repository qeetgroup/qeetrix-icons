/* GENERATED from icons/round-outline/time/calendar-date.svg, icons/round-solid/time/calendar-date.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function CalendarDate({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8760)">
          ...
          <path d="M12.0001 14.09C12.5201 14.09 12.9001 13.78 12.9001 13.29C12.9001 12.79 12.5201 12.5 12.0001 12.5C11.4801 12.5 11.1001 12.79 11.1001 13.29C11.1001 13.78 11.4801 14.09 12.0001 14.09Z" fill="currentColor"/>
          <path d="M12.0001 17.0006C12.6297 17.0006 13.1401 16.5842 13.1401 16.0706C13.1401 15.557 12.6297 15.1406 12.0001 15.1406C11.3705 15.1406 10.8601 15.557 10.8601 16.0706C10.8601 16.5842 11.3705 17.0006 12.0001 17.0006Z" fill="currentColor"/>
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7528)">
        ...
        <path d="M20.75 18.3496H3.25C2.84 18.3496 2.5 18.0096 2.5 17.5996C2.5 17.1896 2.84 16.8496 3.25 16.8496H20.75C21.16 16.8496 21.5 17.1896 21.5 17.5996C21.5 18.0096 21.16 18.3496 20.75 18.3496Z" fill="currentColor"/>
