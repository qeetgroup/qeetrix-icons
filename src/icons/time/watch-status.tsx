/* GENERATED by scripts/generate.mjs from icons/outline/time/watch-status.svg, icons/solid/time/watch-status.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function WatchStatus({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
