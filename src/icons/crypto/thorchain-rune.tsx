/* GENERATED from icons/round-outline/crypto/thorchain-rune.svg, icons/round-solid/crypto/thorchain-rune.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ThorchainRune({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8917)">
          <path d="M16.3799 17.5692L6.07988 21.9092C5.00988 22.3592 4.07986 21.0292 4.86986 20.1792L12.6799 11.6992L16.7298 15.8192C17.2698 16.3592 17.0899 17.2792 16.3799 17.5692Z" fill="currentColor"/>
          <path d="M19.17 3.76918L12.68 11.6992L8.63003 7.59918C8.09003 7.04918 8.27001 6.12918 8.98001 5.83918L17.92 2.08918C18.96 1.64918 19.89 2.89918 19.17 3.76918Z" fill="currentColor"/>
        </g>
        <defs>
