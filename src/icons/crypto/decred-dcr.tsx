/* GENERATED from icons/round-outline/crypto/decred-dcr.svg, icons/round-solid/crypto/decred-dcr.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function DecredDcr({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
