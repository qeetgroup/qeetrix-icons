/* GENERATED from icons/round-outline/interface/milk.svg, icons/round-solid/interface/milk.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Milk({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8567)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7424)">
        ...
        <path d="M18 16.75C17.59 16.75 17.25 16.41 17.25 16V15C17.25 14.59 17.59 14.25 18 14.25C18.41 14.25 18.75 14.59 18.75 15V16C18.75 16.41 18.41 16.75 18 16.75Z" fill="currentColor"/>
        <path d="M6 15.7305C5.59 15.7305 5.25 15.3905 5.25 14.9805V13.9805C5.25 13.5705 5.59 13.2305 6 13.2305C6.41 13.2305 6.75 13.5705 6.75 13.9805V14.9805C6.75 15.3905 6.41 15.7305 6 15.7305Z" fill="currentColor"/>
