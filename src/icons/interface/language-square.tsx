/* GENERATED from icons/round-outline/interface/language-square.svg, icons/round-solid/interface/language-square.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function LanguageSquare({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6688)">
        ...
        <path d="M12 9.71027C11.59 9.71027 11.25 9.37027 11.25 8.96027V7.28027C11.25 6.87027 11.59 6.53027 12 6.53027C12.41 6.53027 12.75 6.87027 12.75 7.28027V8.96027C12.75 9.37027 12.41 9.71027 12 9.71027Z" fill="currentColor"/>
        <path d="M7 17.4694C6.59 17.4694 6.25 17.1294 6.25 16.7194C6.25 16.3094 6.59 15.9694 7 15.9694C10.72 15.9694 13.75 12.8195 13.75 8.93945C13.75 8.52945 14.09 8.18945 14.5 8.18945C14.91 8.18945 15.25 8.52945 15.25 8.93945C15.25 13.6495 11.55 17.4694 7 17.4694Z" fill="currentColor"/>
