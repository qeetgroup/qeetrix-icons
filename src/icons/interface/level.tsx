/* GENERATED by scripts/generate.mjs from icons/outline/interface/level.svg, icons/solid/interface/level.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Level({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      <path
        d="M12 22.7501C6.92003 22.7501 2.49003 19.1401 1.47003 14.1701C1.39003 13.7601 1.65003 13.3701 2.05003 13.2801C2.46003 13.2001 2.85003 13.4601 2.94003 13.8601C3.82003 18.1401 7.63003 21.2501 12 21.2501C16.36 21.2501 20.17 18.1601 21.06 13.9001C21.14 13.4901 21.54 13.2301 21.95 13.3201C22.36 13.4001 22.62 13.8001 22.53 14.2101C21.49 19.1501 17.07 22.7501 12 22.7501Z"
        fill="currentColor"
      />
      <path
        d="M21.81 10.8102C21.46 10.8102 21.15 10.5603 21.08 10.2003C20.23 5.88026 16.41 2.74023 12 2.74023C7.61995 2.74023 3.80996 5.85025 2.93996 10.1302C2.85996 10.5402 2.45996 10.7902 2.04996 10.7102C1.63996 10.6302 1.37996 10.2303 1.46996 9.82025C2.48996 4.85025 6.91995 1.24023 12 1.24023C17.13 1.24023 21.56 4.89025 22.55 9.91025C22.63 10.3202 22.36 10.7103 21.96 10.7903C21.91 10.8103 21.86 10.8102 21.81 10.8102Z"
        fill="currentColor"
      />
      <path
