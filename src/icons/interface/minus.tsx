/* GENERATED from icons/round-outline/interface/minus.svg, icons/round-solid/interface/minus.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Minus({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
