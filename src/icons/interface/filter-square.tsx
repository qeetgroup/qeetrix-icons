/* GENERATED from icons/outline/interface/filter-square.svg, icons/solid/interface/filter-square.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function FilterSquare({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
