/* GENERATED by scripts/generate.mjs from icons/outline/interface/language-circle.svg, icons/solid/interface/language-circle.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function LanguageCircle({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M7 17.4694C6.59 17.4694 6.25 17.1294 6.25 16.7194C6.25 16.3094 6.59 15.9694 7 15.9694C10.72 15.9694 13.75 12.8195 13.75 8.93945C13.75 8.52945 14.09 8.18945 14.5 8.18945C14.91 8.18945 15.25 8.52945 15.25 8.93945C15.25 13.6495 11.55 17.4694 7 17.4694Z"
        fill="currentColor"
      />
      <path
