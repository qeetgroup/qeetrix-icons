/* GENERATED by scripts/generate.mjs from icons/outline/interface/slider-vertical-alt.svg, icons/solid/interface/slider-vertical-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SliderVerticalAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
