/* GENERATED from icons/outline/interface/check.svg, icons/solid/interface/check.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Check({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
