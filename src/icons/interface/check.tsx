/* GENERATED from icons/round-outline/interface/check.svg, icons/round-solid/interface/check.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Check({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8306)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7095)">
        ...
        <path d="M8 16.25C7.59 16.25 7.25 15.91 7.25 15.5V8.5C7.25 8.09 7.59 7.75 8 7.75C8.41 7.75 8.75 8.09 8.75 8.5V15.5C8.75 15.91 8.41 16.25 8 16.25Z" fill="currentColor"/>
      </g>
      <defs>
        <clipPath id="clip0_4418_7095">
          <rect width="24" height="24" fill="white"/>
        </clipPath>
      </defs>
    </svg>
