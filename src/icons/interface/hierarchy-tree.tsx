/* GENERATED by scripts/generate.mjs from icons/outline/interface/hierarchy-tree.svg, icons/solid/interface/hierarchy-tree.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function HierarchyTree({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
