/* GENERATED from icons/outline/interface/hierarchy-tree.svg, icons/solid/interface/hierarchy-tree.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function HierarchyTree({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
