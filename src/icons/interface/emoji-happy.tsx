/* GENERATED by scripts/generate.mjs from icons/outline/interface/emoji-happy.svg, icons/solid/interface/emoji-happy.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function EmojiHappy({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
