/* GENERATED from icons/outline/interface/dots-more.svg, icons/solid/interface/dots-more.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function DotsMore({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
