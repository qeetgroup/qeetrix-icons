/* GENERATED by scripts/generate.mjs from icons/outline/interface/dots-more.svg, icons/solid/interface/dots-more.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function DotsMore({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
