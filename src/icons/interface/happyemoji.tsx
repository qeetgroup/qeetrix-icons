/* GENERATED by scripts/generate.mjs from icons/outline/interface/happyemoji.svg, icons/solid/interface/happyemoji.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Happyemoji({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M11.9999 19.2509C9.84988 19.2509 7.82988 18.2009 6.59988 16.4309C6.35988 16.0909 6.44988 15.6209 6.78988 15.3909C7.12988 15.1509 7.59988 15.2409 7.82988 15.5809C8.77988 16.9409 10.3399 17.7609 11.9999 17.7609C13.6599 17.7609 15.2199 16.9509 16.1699 15.5809C16.4099 15.2409 16.8699 15.1609 17.2099 15.3909C17.5499 15.6309 17.6299 16.0909 17.3999 16.4309C16.1699 18.2009 14.1499 19.2509 11.9999 19.2509Z"
        fill="currentColor"
      />
    </IconBase>
  );
