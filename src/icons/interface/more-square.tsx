/* GENERATED by scripts/generate.mjs from icons/outline/interface/more-square.svg, icons/solid/interface/more-square.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MoreSquare({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
