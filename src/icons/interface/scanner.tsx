/* GENERATED by scripts/generate.mjs from icons/outline/interface/scanner.svg, icons/solid/interface/scanner.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Scanner({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
