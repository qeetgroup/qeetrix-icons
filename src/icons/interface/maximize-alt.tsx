/* GENERATED by scripts/generate.mjs from icons/outline/interface/maximize-alt.svg, icons/solid/interface/maximize-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MaximizeAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
