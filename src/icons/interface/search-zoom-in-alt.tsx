/* GENERATED by scripts/generate.mjs from icons/outline/interface/search-zoom-in-alt.svg, icons/solid/interface/search-zoom-in-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SearchZoomInAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
