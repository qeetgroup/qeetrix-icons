/* GENERATED from icons/round-outline/interface/search-zoom-in-alt.svg, icons/round-solid/interface/search-zoom-in-alt.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function SearchZoomInAlt({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      ...
      <path d="M11.7002 14.95C11.2902 14.95 10.9502 14.61 10.9502 14.2V9.19995C10.9502 8.78995 11.2902 8.44995 11.7002 8.44995C12.1102 8.44995 12.4502 8.78995 12.4502 9.19995V14.2C12.4502 14.61 12.1102 14.95 11.7002 14.95Z" fill="currentColor"/>
