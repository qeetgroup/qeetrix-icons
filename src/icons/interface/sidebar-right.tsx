/* GENERATED from icons/round-outline/interface/sidebar-right.svg, icons/round-solid/interface/sidebar-right.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function SidebarRight({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8536)">
          ...
          <path d="M16.78 2.0293V21.9793C18.01 21.8993 19.05 21.5493 19.87 20.9493C20.29 20.6593 20.66 20.2893 20.95 19.8693C21.64 18.9193 22 17.6793 22 16.1893V7.8093C22 4.3693 20.06 2.2393 16.78 2.0293Z" fill="currentColor"/>
        </g>
        <defs>
          <clipPath id="clip0_4418_8536">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7315)">
        ...
        <path d="M14.97 22.75C14.56 22.75 14.22 22.41 14.22 22V2C14.22 1.59 14.56 1.25 14.97 1.25C15.38 1.25 15.72 1.59 15.72 2V22C15.72 22.41 15.39 22.75 14.97 22.75Z" fill="currentColor"/>
