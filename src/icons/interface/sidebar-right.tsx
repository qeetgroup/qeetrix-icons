/* GENERATED by scripts/generate.mjs from icons/outline/interface/sidebar-right.svg, icons/solid/interface/sidebar-right.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SidebarRight({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M16.78 2.0293V21.9793C18.01 21.8993 19.05 21.5493 19.87 20.9493C20.29 20.6593 20.66 20.2893 20.95 19.8693C21.64 18.9193 22 17.6793 22 16.1893V7.8093C22 4.3693 20.06 2.2393 16.78 2.0293Z"
          fill="currentColor"
        />
      </IconBase>
    );
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M14.97 22.75C14.56 22.75 14.22 22.41 14.22 22V2C14.22 1.59 14.56 1.25 14.97 1.25C15.38 1.25 15.72 1.59 15.72 2V22C15.72 22.41 15.39 22.75 14.97 22.75Z"
        fill="currentColor"
      />
      <path
