    ...
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g clipPath="url(#clip0_4418_8859)">
          <path d="M12.7 16.8798H13.4C14.55 16.8798 15.49 15.9398 15.49 14.7898V14.0898H12.7V16.8798Z" fill="white"/>
          <path d="M8.51001 14.7898C8.51001 15.9398 9.45001 16.8798 10.6 16.8798H11.3V14.0898H8.51001V14.7898Z" fill="white"/>
          <path d="M8.51001 12.0002V12.7002H11.3V9.91016H10.6C9.45001 9.91016 8.51001 10.8502 8.51001 12.0002Z" fill="white"/>
          <path d="M20.03 6.81969L14.28 2.78969C12.71 1.68969 10.31 1.74969 8.8 2.91969L3.79 6.82969C2.78 7.60969 2 9.20969 2 10.4697V17.3697C2 19.9197 4.07 21.9997 6.61 21.9997H17.38C19.92 21.9997 21.99 19.9297 21.99 17.3797V10.5997C22 9.24969 21.13 7.58969 20.03 6.81969ZM16.88 14.7897C16.88 16.7097 15.31 18.2797 13.39 18.2797H10.6C8.68 18.2797 7.11 16.7197 7.11 14.7897V11.9997C7.11 10.0797 8.68 8.50969 10.6 8.50969H13.39C15.31 8.50969 16.88 10.0697 16.88 11.9997V14.7897Z" fill="white"/>
          <path d="M13.4 9.91016H12.7V12.7002H15.49V12.0002C15.49 10.8502 14.55 9.91016 13.4 9.91016Z" fill="white"/>
        </g>
        <defs>
