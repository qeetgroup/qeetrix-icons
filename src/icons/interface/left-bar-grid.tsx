/* GENERATED from icons/outline/interface/left-bar-grid.svg, icons/solid/interface/left-bar-grid.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function LeftBarGrid({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
