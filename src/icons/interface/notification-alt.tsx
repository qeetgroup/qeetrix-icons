/* GENERATED by scripts/generate.mjs from icons/outline/interface/notification-alt.svg, icons/solid/interface/notification-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function NotificationAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
