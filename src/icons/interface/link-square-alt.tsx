/* GENERATED by scripts/generate.mjs from icons/outline/interface/link-square-alt.svg, icons/solid/interface/link-square-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function LinkSquareAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
