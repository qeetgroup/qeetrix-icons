/* GENERATED from icons/outline/interface/home.svg, icons/solid/interface/home.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Home({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
