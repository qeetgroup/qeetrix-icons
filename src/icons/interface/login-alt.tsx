/* GENERATED by scripts/generate.mjs from icons/outline/interface/login-alt.svg, icons/solid/interface/login-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function LoginAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M12.6501 16.0998C12.4601 16.0998 12.2701 16.0298 12.1201 15.8798C11.8301 15.5898 11.8301 15.1098 12.1201 14.8198L14.9401 11.9998L12.1201 9.17984C11.8301 8.88984 11.8301 8.40984 12.1201 8.11984C12.4101 7.82984 12.8901 7.82984 13.1801 8.11984L16.5301 11.4698C16.8201 11.7598 16.8201 12.2398 16.5301 12.5298L13.1801 15.8798C13.0301 16.0298 12.8401 16.0998 12.6501 16.0998Z"
        fill="currentColor"
      />
    </IconBase>
  );
