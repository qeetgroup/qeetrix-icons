/* GENERATED by scripts/generate.mjs from icons/outline/interface/speedometer.svg, icons/solid/interface/speedometer.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Speedometer({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M11.9999 22.25C9.72988 22.25 7.87988 20.4 7.87988 18.13C7.87988 15.86 9.72988 14 11.9999 14C14.2699 14 16.1199 15.85 16.1199 18.12C16.1199 20.39 14.2699 22.25 11.9999 22.25ZM11.9999 15.5C10.5499 15.5 9.37988 16.68 9.37988 18.12C9.37988 19.56 10.5599 20.74 11.9999 20.74C13.4399 20.74 14.6199 19.56 14.6199 18.12C14.6199 16.68 13.4499 15.5 11.9999 15.5Z"
        fill="currentColor"
      />
      <path
