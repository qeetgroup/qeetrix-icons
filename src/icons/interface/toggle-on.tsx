/* GENERATED from icons/round-outline/interface/toggle-on.svg, icons/round-solid/interface/toggle-on.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ToggleOn({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
