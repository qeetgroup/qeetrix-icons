/* GENERATED by scripts/generate.mjs from icons/outline/interface/slider.svg, icons/solid/interface/slider.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Slider({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M18 16.0098C18.55 16.0098 19 16.4598 19 17.0098V17.9998C19 20.1998 17.5 21.9998 15 21.9998H9C6.5 21.9998 5 20.1998 5 17.9998V17.0098C5 16.4598 5.45 16.0098 6 16.0098H18Z"
          fill="currentColor"
        />
        <path
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M19 16.7598H5C4.59 16.7598 4.25 16.4198 4.25 16.0098C4.25 15.5998 4.59 15.2598 5 15.2598H19C19.41 15.2598 19.75 15.5998 19.75 16.0098C19.75 16.4198 19.41 16.7598 19 16.7598Z"
        fill="currentColor"
      />
      <path
