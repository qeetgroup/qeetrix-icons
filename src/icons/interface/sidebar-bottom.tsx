/* GENERATED by scripts/generate.mjs from icons/outline/interface/sidebar-bottom.svg, icons/solid/interface/sidebar-bottom.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SidebarBottom({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M3.05002 19.8693C3.34002 20.2893 3.71002 20.6593 4.13002 20.9493C5.08002 21.6393 6.32002 21.9993 7.81002 21.9993H16.19C19.63 21.9993 21.76 20.0593 21.97 16.7793H2.02002C2.10002 18.0093 2.45002 19.0493 3.05002 19.8693Z"
          fill="currentColor"
        />
        <path
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M11.9999 11.8095C11.8099 11.8095 11.6199 11.7395 11.4699 11.5895L8.90988 9.02945C8.61988 8.73945 8.61988 8.25945 8.90988 7.96945C9.19988 7.67945 9.67988 7.67945 9.96988 7.96945L11.9999 9.99945L14.0299 7.96945C14.3199 7.67945 14.7999 7.67945 15.0899 7.96945C15.3799 8.25945 15.3799 8.73945 15.0899 9.02945L12.5299 11.5895C12.3799 11.7395 12.1899 11.8095 11.9999 11.8095Z"
        fill="currentColor"
      />
    </IconBase>
  );
