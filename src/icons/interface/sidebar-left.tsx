/* GENERATED by scripts/generate.mjs from icons/outline/interface/sidebar-left.svg, icons/solid/interface/sidebar-left.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SidebarLeft({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M2 7.8093V16.1893C2 17.6793 2.36 18.9193 3.05 19.8693C3.34 20.2893 3.71 20.6593 4.13 20.9493C4.95 21.5493 5.99 21.8993 7.22 21.9793V2.0293C3.94 2.2393 2 4.3693 2 7.8093Z"
          fill="currentColor"
        />
        <path
