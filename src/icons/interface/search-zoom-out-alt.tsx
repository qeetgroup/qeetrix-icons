/* GENERATED by scripts/generate.mjs from icons/outline/interface/search-zoom-out-alt.svg, icons/solid/interface/search-zoom-out-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SearchZoomOutAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
