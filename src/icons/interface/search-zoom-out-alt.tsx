/* GENERATED from icons/round-outline/interface/search-zoom-out-alt.svg, icons/round-solid/interface/search-zoom-out-alt.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function SearchZoomOutAlt({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
