/* GENERATED by scripts/generate.mjs from icons/outline/interface/house-2.svg, icons/solid/interface/house-2.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function House2({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
