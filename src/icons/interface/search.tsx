/* GENERATED from icons/round-outline/interface/search.svg, icons/round-solid/interface/search.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Search({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
