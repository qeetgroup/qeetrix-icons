/* GENERATED by scripts/generate.mjs from icons/outline/interface/grid-equal.svg, icons/solid/interface/grid-equal.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function GridEqual({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
