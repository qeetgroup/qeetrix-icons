/* GENERATED from icons/outline/interface/emoji-sad.svg, icons/solid/interface/emoji-sad.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function EmojiSad({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g clipPath="url(#clip0_4418_8636)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_4418_7360)">
        <path d="M15 22.75H9C3.57 22.75 1.25 20.43 1.25 15V9C1.25 3.57 3.57 1.25 9 1.25H15C20.43 1.25 22.75 3.57 22.75 9V15C22.75 20.43 20.43 22.75 15 22.75ZM9 2.75C4.39 2.75 2.75 4.39 2.75 9V15C2.75 19.61 4.39 21.25 9 21.25H15C19.61 21.25 21.25 19.61 21.25 15V9C21.25 4.39 19.61 2.75 15 2.75H9Z" fill="white"/>
        <path d="M10.6399 9.49945C10.4499 9.49945 10.2599 9.42945 10.1099 9.27945C9.39994 8.56945 8.23994 8.56945 7.52994 9.27945C7.23994 9.56945 6.75994 9.56945 6.46994 9.27945C6.17994 8.98945 6.17994 8.50945 6.46994 8.21945C7.75994 6.92945 9.86994 6.92945 11.1699 8.21945C11.4599 8.50945 11.4599 8.98945 11.1699 9.27945C11.0199 9.42945 10.8299 9.49945 10.6399 9.49945Z" fill="white"/>
        <path d="M13.36 9.49945C13.17 9.49945 12.98 9.42945 12.83 9.27945C12.54 8.98945 12.54 8.50945 12.83 8.21945C14.12 6.92945 16.23 6.92945 17.53 8.21945C17.82 8.50945 17.82 8.98945 17.53 9.27945C17.24 9.56945 16.76 9.56945 16.47 9.27945C15.76 8.56945 14.6 8.56945 13.89 9.27945C13.75 9.42945 13.56 9.49945 13.36 9.49945Z" fill="white"/>
        <path d="M15.6 18.4508H8.4C7.49 18.4508 6.75 17.7108 6.75 16.8008C6.75 13.9108 9.1 11.5508 12 11.5508C14.9 11.5508 17.25 13.9108 17.25 16.8008C17.25 17.7108 16.51 18.4508 15.6 18.4508ZM12 13.0508C9.93 13.0508 8.25 14.7308 8.25 16.8008C8.25 16.8808 8.32 16.9508 8.4 16.9508H15.6C15.68 16.9508 15.75 16.8808 15.75 16.8008C15.75 14.7308 14.07 13.0508 12 13.0508Z" fill="white"/>
      </g>
      <defs>
        <clipPath id="clip0_4418_7360">
          <rect width="24" height="24" fill="white"/>
        </clipPath>
      </defs>
    </svg>
