/* GENERATED from icons/outline/interface/grids-4.svg, icons/solid/interface/grids-4.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Grids4({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
