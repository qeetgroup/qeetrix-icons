/* GENERATED from icons/outline/interface/grid-add.svg, icons/solid/interface/grid-add.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function GridAdd({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
