/* GENERATED from icons/round-outline/interface/grid-add.svg, icons/round-solid/interface/grid-add.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function GridAdd({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8409)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7180)">
        ...
        <path d="M20.5 18.25H14.5C14.09 18.25 13.75 17.91 13.75 17.5C13.75 17.09 14.09 16.75 14.5 16.75H20.5C20.91 16.75 21.25 17.09 21.25 17.5C21.25 17.91 20.91 18.25 20.5 18.25Z" fill="currentColor"/>
        <path d="M17.5 21.25C17.09 21.25 16.75 20.91 16.75 20.5V14.5C16.75 14.09 17.09 13.75 17.5 13.75C17.91 13.75 18.25 14.09 18.25 14.5V20.5C18.25 20.91 17.91 21.25 17.5 21.25Z" fill="currentColor"/>
      </g>
      <defs>
        <clipPath id="clip0_4418_7180">
          <rect width="24" height="24" fill="white"/>
        </clipPath>
      </defs>
    </svg>
