/* GENERATED by scripts/generate.mjs from icons/outline/interface/grid-add.svg, icons/solid/interface/grid-add.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function GridAdd({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
