/* GENERATED by scripts/generate.mjs from icons/outline/interface/slider-horizontal-alt.svg, icons/solid/interface/slider-horizontal-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function SliderHorizontalAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M3.5 5.06055V18.9405C3.5 19.3505 3.16 19.6905 2.75 19.6905C2.34 19.6905 2 19.3505 2 18.9405V5.06055C2 4.65055 2.34 4.31055 2.75 4.31055C3.16 4.31055 3.5 4.65055 3.5 5.06055Z"
          fill="currentColor"
        />
        <path
          d="M22 5.06055V18.9405C22 19.3505 21.66 19.6905 21.25 19.6905C20.84 19.6905 20.5 19.3505 20.5 18.9405V5.06055C20.5 4.65055 20.84 4.31055 21.25 4.31055C21.66 4.31055 22 4.65055 22 5.06055Z"
          fill="currentColor"
        />
        <path
