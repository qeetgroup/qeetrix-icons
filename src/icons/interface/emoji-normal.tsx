/* GENERATED from icons/round-outline/interface/emoji-normal.svg, icons/round-solid/interface/emoji-normal.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function EmojiNormal({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
