/* GENERATED by scripts/generate.mjs from icons/outline/interface/buildings.svg, icons/solid/interface/buildings.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Buildings({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
