/* GENERATED by scripts/generate.mjs from icons/outline/interface/notification-status.svg, icons/solid/interface/notification-status.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function NotificationStatus({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
