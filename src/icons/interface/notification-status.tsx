/* GENERATED from icons/round-outline/interface/notification-status.svg, icons/round-solid/interface/notification-status.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function NotificationStatus({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
