/* GENERATED by scripts/generate.mjs from icons/outline/interface/aquarius.svg, icons/solid/interface/aquarius.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Aquarius({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
