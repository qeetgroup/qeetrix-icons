/* GENERATED by scripts/generate.mjs from icons/outline/interface/hashtag.svg, icons/solid/interface/hashtag.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Hashtag({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      <path
        d="M8.00009 21.7495C7.97009 21.7495 7.94009 21.7495 7.92009 21.7495C7.51009 21.6995 7.21009 21.3295 7.26009 20.9195L9.26009 2.91954C9.31009 2.50954 9.68009 2.21954 10.0901 2.25954C10.5001 2.30954 10.8001 2.67954 10.7501 3.08954L8.75009 21.0895C8.70009 21.4695 8.38009 21.7495 8.00009 21.7495Z"
        fill="currentColor"
      />
      <path
        d="M14.0001 21.7495C13.9701 21.7495 13.9401 21.7495 13.9201 21.7495C13.5101 21.6995 13.2101 21.3295 13.2601 20.9195L15.2601 2.91954C15.3101 2.50954 15.6701 2.21954 16.0901 2.25954C16.5001 2.30954 16.8001 2.67954 16.7501 3.08954L14.7501 21.0895C14.7001 21.4695 14.3801 21.7495 14.0001 21.7495Z"
        fill="currentColor"
      />
      <path
