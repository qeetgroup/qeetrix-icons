/* GENERATED from icons/round-outline/interface/forbidden-2.svg, icons/round-solid/interface/forbidden-2.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Forbidden2({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_4418_8574)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7335)">
        ...
        <path d="M8.49994 16.2495C8.30994 16.2495 8.11994 16.1795 7.96994 16.0295C7.67994 15.7395 7.67994 15.2595 7.96994 14.9695L14.9699 7.96945C15.2599 7.67945 15.7399 7.67945 16.0299 7.96945C16.3199 8.25945 16.3199 8.73945 16.0299 9.02945L9.02994 16.0295C8.87994 16.1795 8.68994 16.2495 8.49994 16.2495Z" fill="currentColor"/>
        <path d="M15.4999 16.2495C15.3099 16.2495 15.1199 16.1795 14.9699 16.0295L7.96994 9.02945C7.67994 8.73945 7.67994 8.25945 7.96994 7.96945C8.25994 7.67945 8.73994 7.67945 9.02994 7.96945L16.0299 14.9695C16.3199 15.2595 16.3199 15.7395 16.0299 16.0295C15.8799 16.1795 15.6899 16.2495 15.4999 16.2495Z" fill="currentColor"/>
      </g>
      <defs>
        <clipPath id="clip0_4418_7335">
          <rect width="24" height="24" fill="white"/>
        </clipPath>
      </defs>
    </svg>
