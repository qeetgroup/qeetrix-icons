/* GENERATED by scripts/generate.mjs from icons/outline/interface/more-circle.svg, icons/solid/interface/more-circle.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MoreCircle({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
