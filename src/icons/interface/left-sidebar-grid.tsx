/* GENERATED from icons/round-outline/interface/left-sidebar-grid.svg, icons/round-solid/interface/left-sidebar-grid.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function LeftSidebarGrid({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
