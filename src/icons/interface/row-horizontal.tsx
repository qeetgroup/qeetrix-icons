/* GENERATED from icons/outline/interface/row-horizontal.svg, icons/solid/interface/row-horizontal.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function RowHorizontal({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
