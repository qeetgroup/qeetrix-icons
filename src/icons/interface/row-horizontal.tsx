/* GENERATED by scripts/generate.mjs from icons/outline/interface/row-horizontal.svg, icons/solid/interface/row-horizontal.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function RowHorizontal({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
