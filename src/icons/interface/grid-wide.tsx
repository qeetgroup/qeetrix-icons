/* GENERATED by scripts/generate.mjs from icons/outline/interface/grid-wide.svg, icons/solid/interface/grid-wide.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function GridWide({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
