/* GENERATED from icons/outline/interface/top-bottom-grid.svg, icons/solid/interface/top-bottom-grid.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function TopBottomGrid({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
