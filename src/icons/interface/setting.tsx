/* GENERATED from icons/outline/interface/setting.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Setting({ variant: _variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" }) {
  return (
