/* GENERATED by scripts/generate.mjs from icons/outline/interface/tick-square.svg, icons/solid/interface/tick-square.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function TickSquare({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
