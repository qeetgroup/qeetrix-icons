/* GENERATED by scripts/generate.mjs from icons/outline/interface/grid-large.svg, icons/solid/interface/grid-large.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function GridLarge({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
