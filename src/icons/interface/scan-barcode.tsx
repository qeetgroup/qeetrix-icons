/* GENERATED by scripts/generate.mjs from icons/outline/interface/scan-barcode.svg, icons/solid/interface/scan-barcode.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ScanBarcode({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
