/* GENERATED by scripts/generate.mjs from icons/outline/editing/textalign-center.svg, icons/solid/editing/textalign-center.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function TextalignCenter({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
