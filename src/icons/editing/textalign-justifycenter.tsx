/* GENERATED by scripts/generate.mjs from icons/outline/editing/textalign-justifycenter.svg, icons/solid/editing/textalign-justifycenter.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function TextalignJustifycenter({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
