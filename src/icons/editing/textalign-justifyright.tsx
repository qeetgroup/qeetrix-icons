/* GENERATED by scripts/generate.mjs from icons/outline/editing/textalign-justifyright.svg, icons/solid/editing/textalign-justifyright.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function TextalignJustifyright({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
