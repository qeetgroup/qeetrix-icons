/* GENERATED by scripts/generate.mjs from icons/outline/editing/align-vertically.svg, icons/solid/editing/align-vertically.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function AlignVertically({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M12 22.7496C11.59 22.7496 11.25 22.4096 11.25 21.9996V19.5996C11.25 19.1896 11.59 18.8496 12 18.8496C12.41 18.8496 12.75 19.1896 12.75 19.5996V21.9996C12.75 22.4096 12.41 22.7496 12 22.7496Z"
        fill="currentColor"
      />
      <path
