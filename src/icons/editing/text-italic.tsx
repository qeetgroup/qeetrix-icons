/* GENERATED from icons/round-outline/editing/text-italic.svg, icons/round-solid/editing/text-italic.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function TextItalic({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6675)">
        <path d="M18.8799 3.75H9.61988C9.20988 3.75 8.87988 3.41 8.87988 3C8.87988 2.59 9.21988 2.25 9.62988 2.25H18.8799C19.2899 2.25 19.6299 2.59 19.6299 3C19.6299 3.41 19.2899 3.75 18.8799 3.75Z" fill="currentColor"/>
        <path d="M14.3801 21.75H5.12012C4.71012 21.75 4.37012 21.41 4.37012 21C4.37012 20.59 4.71012 20.25 5.12012 20.25H14.3701C14.7801 20.25 15.1201 20.59 15.1201 21C15.1201 21.41 14.7901 21.75 14.3801 21.75Z" fill="currentColor"/>
