/* GENERATED from icons/round-outline/editing/textalign-left.svg, icons/round-solid/editing/textalign-left.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function TextalignLeft({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
