/* GENERATED from icons/round-outline/editing/align-left-alt.svg, icons/round-solid/editing/align-left-alt.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function AlignLeftAlt({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_7186)">
        ...
        <path d="M12.9 11.25H4.1C2.18 11.25 1.25 10.27 1.25 8.27V4.23C1.25 2.22 2.18 1.25 4.1 1.25H12.9C14.82 1.25 15.75 2.23 15.75 4.23V8.27C15.75 10.27 14.82 11.25 12.9 11.25ZM4.1 2.75C3.09 2.75 2.75 2.96 2.75 4.23V8.27C2.75 9.54 3.09 9.75 4.1 9.75H12.9C13.91 9.75 14.25 9.54 14.25 8.27V4.23C14.25 2.96 13.91 2.75 12.9 2.75H4.1Z" fill="currentColor"/>
      </g>
      <defs>
