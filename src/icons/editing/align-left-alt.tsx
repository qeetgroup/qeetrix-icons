/* GENERATED by scripts/generate.mjs from icons/outline/editing/align-left-alt.svg, icons/solid/editing/align-left-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function AlignLeftAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
