/* GENERATED from icons/round-outline/editing/subtitle.svg, icons/round-solid/editing/subtitle.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Subtitle({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_6800)">
        ...
        <path d="M17.5 14.0703H11.97C11.56 14.0703 11.22 13.7303 11.22 13.3203C11.22 12.9103 11.56 12.5703 11.97 12.5703H17.5C17.91 12.5703 18.25 12.9103 18.25 13.3203C18.25 13.7303 17.91 14.0703 17.5 14.0703Z" fill="currentColor"/>
