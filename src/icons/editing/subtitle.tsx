/* GENERATED by scripts/generate.mjs from icons/outline/editing/subtitle.svg, icons/solid/editing/subtitle.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Subtitle({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M17.4999 17.8301H15.6499C15.2399 17.8301 14.8999 17.4901 14.8999 17.0801C14.8999 16.6701 15.2399 16.3301 15.6499 16.3301H17.4999C17.9099 16.3301 18.2499 16.6701 18.2499 17.0801C18.2499 17.4901 17.9099 17.8301 17.4999 17.8301Z"
        fill="currentColor"
      />
      <path
      ...
      />
      <path
        d="M17.5 14.0703H11.97C11.56 14.0703 11.22 13.7303 11.22 13.3203C11.22 12.9103 11.56 12.5703 11.97 12.5703H17.5C17.91 12.5703 18.25 12.9103 18.25 13.3203C18.25 13.7303 17.91 14.0703 17.5 14.0703Z"
        fill="currentColor"
      />
      <path
