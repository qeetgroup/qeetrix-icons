/* GENERATED by scripts/generate.mjs from icons/outline/editing/textalign-justifyleft.svg, icons/solid/editing/textalign-justifyleft.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function TextalignJustifyleft({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
