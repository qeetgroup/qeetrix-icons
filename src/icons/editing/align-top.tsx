/* GENERATED from icons/round-outline/editing/align-top.svg, icons/round-solid/editing/align-top.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function AlignTop({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
