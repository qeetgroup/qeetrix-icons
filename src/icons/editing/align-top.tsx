/* GENERATED by scripts/generate.mjs from icons/outline/editing/align-top.svg, icons/solid/editing/align-top.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function AlignTop({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
