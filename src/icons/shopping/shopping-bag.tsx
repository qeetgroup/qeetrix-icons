/* GENERATED by scripts/generate.mjs from icons/outline/shopping/shopping-bag.svg, icons/solid/shopping/shopping-bag.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ShoppingBag({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M8.00009 17.78C7.59009 17.78 7.25009 17.44 7.25009 17.03C7.25009 16.61 7.59009 16.28 8.00009 16.28H19.7601C20.0601 16.28 20.2901 16.02 20.2601 15.72L19.5801 10.03C19.3401 8.09 19.0001 6.5 15.6001 6.5H8.40009C5.00009 6.5 4.66009 8.09 4.43009 10.03L3.53009 17.53C3.24009 19.99 4.00009 22 7.51009 22H16.4901C19.6501 22 20.5801 20.37 20.5301 18.25C20.5201 17.98 20.3001 17.78 20.0301 17.78H8.00009Z"
          fill="currentColor"
        />
      </IconBase>
    );
