/* GENERATED from icons/round-outline/shopping/shopping-bag.svg, icons/round-solid/shopping/shopping-bag.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ShoppingBag({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
