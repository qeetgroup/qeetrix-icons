/* GENERATED by scripts/generate.mjs from icons/outline/shopping/ticket.svg, icons/solid/shopping/ticket.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Ticket({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
