/* GENERATED from icons/outline/shopping/shopping-cart.svg, icons/solid/shopping/shopping-cart.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ShoppingCart({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
