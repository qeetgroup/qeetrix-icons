/* GENERATED by scripts/generate.mjs from icons/outline/data/chart-ring.svg, icons/solid/data/chart-ring.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ChartRing({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
