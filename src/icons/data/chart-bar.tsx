/* GENERATED from icons/round-outline/data/chart-bar.svg, icons/round-solid/data/chart-bar.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ChartBar({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
