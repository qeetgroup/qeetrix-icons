/* GENERATED by scripts/generate.mjs from icons/outline/data/chart-bar.svg, icons/solid/data/chart-bar.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ChartBar({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
