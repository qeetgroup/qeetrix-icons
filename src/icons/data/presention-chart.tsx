/* GENERATED by scripts/generate.mjs from icons/solid/data/presention-chart.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function PresentionChart({ variant = "solid", ...props }: QeetrixIconProps & { variant?: "solid" }) {
  return (
