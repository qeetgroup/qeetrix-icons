/* GENERATED from icons/round-outline/data/trend-down.svg, icons/round-solid/data/trend-down.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function TrendDown({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
