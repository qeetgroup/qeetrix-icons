/* GENERATED from icons/round-outline/social/instagram.svg, icons/round-solid/social/instagram.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Instagram({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
