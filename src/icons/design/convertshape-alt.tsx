/* GENERATED by scripts/generate.mjs from icons/outline/design/convertshape-alt.svg, icons/solid/design/convertshape-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ConvertshapeAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M14.78 21.9995C14.51 21.9995 14.26 21.8495 14.13 21.6195C14 21.3795 14 21.0995 14.14 20.8595L15.11 19.2395C15.32 18.8795 15.78 18.7695 16.14 18.9795C16.5 19.1895 16.61 19.6495 16.4 20.0095L16.22 20.3095C18.69 19.6695 20.51 17.4295 20.51 14.7695C20.51 14.3595 20.85 14.0195 21.26 14.0195C21.67 14.0195 22 14.3595 22 14.7795C22 18.7595 18.76 21.9995 14.78 21.9995Z"
          fill="currentColor"
        />
        <path
