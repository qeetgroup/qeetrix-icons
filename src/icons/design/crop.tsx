/* GENERATED by scripts/generate.mjs from icons/outline/design/crop.svg, icons/solid/design/crop.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Crop({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M21.25 17.7207H18.47C18.06 17.7207 17.72 18.0607 17.72 18.4707V21.2507C17.72 21.6607 18.06 22.0007 18.47 22.0007C18.88 22.0007 19.22 21.6607 19.22 21.2507V19.2207H21.25C21.66 19.2207 22 18.8807 22 18.4707C22 18.0607 21.66 17.7207 21.25 17.7207Z"
          fill="currentColor"
        />
        <path
