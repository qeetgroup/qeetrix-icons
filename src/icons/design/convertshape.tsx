/* GENERATED by scripts/generate.mjs from icons/outline/design/convertshape.svg, icons/solid/design/convertshape.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Convertshape({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
