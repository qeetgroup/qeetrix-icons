/* GENERATED by scripts/generate.mjs from icons/outline/design/component.svg, icons/solid/design/component.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Component({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M20.95 14.55L14.56 20.94C13.16 22.34 10.86 22.34 9.45001 20.94L3.06001 14.55C1.66001 13.15 1.66001 10.85 3.06001 9.44L9.45001 3.05C10.85 1.65 13.15 1.65 14.56 3.05L20.95 9.44C22.35 10.85 22.35 13.15 20.95 14.55Z"
          fill="currentColor"
        />
      </IconBase>
    );
