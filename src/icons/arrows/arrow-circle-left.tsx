/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-circle-left.svg, icons/solid/arrows/arrow-circle-left.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowCircleLeft({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
