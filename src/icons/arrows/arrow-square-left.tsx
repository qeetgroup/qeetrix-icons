/* GENERATED from icons/outline/arrows/arrow-square-left.svg, icons/solid/arrows/arrow-square-left.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowSquareLeft({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
