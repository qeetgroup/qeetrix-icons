/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-square-left.svg, icons/solid/arrows/arrow-square-left.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowSquareLeft({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
