/* GENERATED from icons/round-outline/arrows/import-circle.svg, icons/round-solid/arrows/import-circle.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ImportCircle({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        ...
        <path d="M12.6799 3.99023C12.6799 3.58023 12.3399 3.24023 11.9299 3.24023C11.5199 3.24023 11.1799 3.58023 11.1799 3.99023V9.89023H12.6799V3.99023Z" fill="currentColor"/>
      </svg>
    );
  }
  return (
