/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-circle-right.svg, icons/solid/arrows/arrow-circle-right.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowCircleRight({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
