/* GENERATED from icons/round-outline/arrows/arrow-circle-right.svg, icons/round-solid/arrows/arrow-circle-right.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowCircleRight({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
