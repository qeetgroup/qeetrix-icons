/* GENERATED from icons/outline/arrows/arrow-circle-right.svg, icons/solid/arrows/arrow-circle-right.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowCircleRight({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
