/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-up-filled.svg, icons/solid/arrows/arrow-up-filled.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowUpFilled({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
