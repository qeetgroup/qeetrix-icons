/* GENERATED from icons/outline/arrows/arrow-square-right.svg, icons/solid/arrows/arrow-square-right.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowSquareRight({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
