/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-square-right.svg, icons/solid/arrows/arrow-square-right.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowSquareRight({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
