/* GENERATED by scripts/generate.mjs from icons/outline/arrows/redo-arrow.svg, icons/solid/arrows/redo-arrow.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function RedoArrow({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
