/* GENERATED from icons/round-outline/arrows/redo-arrow.svg, icons/round-solid/arrows/redo-arrow.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function RedoArrow({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
