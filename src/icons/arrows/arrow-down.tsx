/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-down.svg, icons/solid/arrows/arrow-down.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowDown({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
