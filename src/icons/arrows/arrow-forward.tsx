/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-forward.svg, icons/solid/arrows/arrow-forward.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowForward({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
