/* GENERATED by scripts/generate.mjs from icons/outline/arrows/refresh-square.svg, icons/solid/arrows/refresh-square.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function RefreshSquare({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
