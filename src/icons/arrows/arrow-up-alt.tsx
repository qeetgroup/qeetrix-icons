/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-up-alt.svg, icons/solid/arrows/arrow-up-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowUpAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
