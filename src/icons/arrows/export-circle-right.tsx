/* GENERATED by scripts/generate.mjs from icons/outline/arrows/export-circle-right.svg, icons/solid/arrows/export-circle-right.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ExportCircleRight({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
