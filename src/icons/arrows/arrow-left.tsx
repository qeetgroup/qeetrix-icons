/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-left.svg, icons/solid/arrows/arrow-left.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowLeft({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
