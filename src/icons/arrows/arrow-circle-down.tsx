/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-circle-down.svg, icons/solid/arrows/arrow-circle-down.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowCircleDown({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
