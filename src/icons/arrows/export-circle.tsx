/* GENERATED by scripts/generate.mjs from icons/outline/arrows/export-circle.svg, icons/solid/arrows/export-circle.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ExportCircle({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        <path
          d="M21.14 9.90039H12.75V15.3804C12.75 15.7904 12.41 16.1304 12 16.1304C11.59 16.1304 11.25 15.7904 11.25 15.3804V9.90039H2.86C2.38 9.90039 2 10.2804 2 10.7604C2 16.6504 6.11 20.7604 12 20.7604C17.89 20.7604 22 16.6504 22 10.7604C22 10.2804 21.62 9.90039 21.14 9.90039Z"
          fill="currentColor"
        />
        <path
          d="M12.7499 5.79969L14.3099 7.35969C14.5999 7.64969 15.0799 7.64969 15.3699 7.35969C15.6599 7.06969 15.6599 6.58969 15.3699 6.29969L12.5199 3.45969C12.2299 3.16969 11.7499 3.16969 11.4599 3.45969L8.6199 6.30969C8.4799 6.45969 8.3999 6.64969 8.3999 6.83969C8.3999 7.02969 8.4699 7.21969 8.6199 7.36969C8.9099 7.65969 9.3899 7.65969 9.6799 7.36969L11.2399 5.80969V9.89969H12.7399V5.79969H12.7499Z"
          fill="currentColor"
        />
      </IconBase>
    );
