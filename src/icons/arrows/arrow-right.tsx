/* GENERATED from icons/round-outline/arrows/arrow-right.svg, icons/round-solid/arrows/arrow-right.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowRight({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
