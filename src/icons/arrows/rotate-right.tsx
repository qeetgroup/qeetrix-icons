/* GENERATED by scripts/generate.mjs from icons/outline/arrows/rotate-right.svg, icons/solid/arrows/rotate-right.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function RotateRight({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
