/* GENERATED from icons/round-outline/arrows/undo-arrow.svg, icons/round-solid/arrows/undo-arrow.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function UndoArrow({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
