/* GENERATED by scripts/generate.mjs from icons/outline/arrows/undo-arrow.svg, icons/solid/arrows/undo-arrow.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function UndoArrow({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
