/* GENERATED from icons/outline/arrows/undo-arrow.svg, icons/solid/arrows/undo-arrow.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function UndoArrow({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
