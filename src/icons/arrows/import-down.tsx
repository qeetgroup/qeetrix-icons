/* GENERATED by scripts/generate.mjs from icons/outline/arrows/import-down.svg, icons/solid/arrows/import-down.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ImportDown({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
