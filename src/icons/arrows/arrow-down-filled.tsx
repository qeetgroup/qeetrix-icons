/* GENERATED from icons/outline/arrows/arrow-down-filled.svg, icons/solid/arrows/arrow-down-filled.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowDownFilled({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
