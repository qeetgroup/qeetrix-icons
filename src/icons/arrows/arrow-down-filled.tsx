/* GENERATED from icons/round-outline/arrows/arrow-down-filled.svg, icons/round-solid/arrows/arrow-down-filled.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ArrowDownFilled({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
