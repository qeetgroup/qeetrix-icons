/* GENERATED from icons/outline/arrows/refresh-arrow.svg, icons/solid/arrows/refresh-arrow.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function RefreshArrow({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
