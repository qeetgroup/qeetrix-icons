/* GENERATED from icons/round-outline/arrows/refresh-arrow.svg, icons/round-solid/arrows/refresh-arrow.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function RefreshArrow({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
