/* GENERATED from icons/round-outline/arrows/import-circle-left.svg, icons/round-solid/arrows/import-circle-left.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ImportCircleLeft({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      ...
      <path d="M13.8 10.9504C13.61 10.9504 13.42 10.8804 13.27 10.7304C12.98 10.4404 12.98 9.96043 13.27 9.67043L21.47 1.47043C21.76 1.18043 22.24 1.18043 22.53 1.47043C22.82 1.76043 22.82 2.24043 22.53 2.53043L14.33 10.7304C14.19 10.8704 14 10.9504 13.8 10.9504Z" fill="currentColor"/>
      <path d="M17.83 11.7499H13C12.59 11.7499 12.25 11.4099 12.25 10.9999V6.16992C12.25 5.75992 12.59 5.41992 13 5.41992C13.41 5.41992 13.75 5.75992 13.75 6.16992V10.2499H17.83C18.24 10.2499 18.58 10.5899 18.58 10.9999C18.58 11.4099 18.24 11.7499 17.83 11.7499Z" fill="currentColor"/>
    </svg>
  );
}
