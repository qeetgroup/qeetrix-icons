/* GENERATED by scripts/generate.mjs from icons/outline/arrows/import-circle-left.svg, icons/solid/arrows/import-circle-left.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ImportCircleLeft({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M13.8 10.9504C13.61 10.9504 13.42 10.8804 13.27 10.7304C12.98 10.4404 12.98 9.96043 13.27 9.67043L21.47 1.47043C21.76 1.18043 22.24 1.18043 22.53 1.47043C22.82 1.76043 22.82 2.24043 22.53 2.53043L14.33 10.7304C14.19 10.8704 14 10.9504 13.8 10.9504Z"
        fill="currentColor"
      />
      <path
