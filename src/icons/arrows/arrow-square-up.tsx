/* GENERATED by scripts/generate.mjs from icons/outline/arrows/arrow-square-up.svg, icons/solid/arrows/arrow-square-up.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ArrowSquareUp({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
