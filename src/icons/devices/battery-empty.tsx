/* GENERATED by scripts/generate.mjs from icons/outline/devices/battery-empty.svg, icons/solid/devices/battery-empty.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function BatteryEmpty({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
