/* GENERATED by scripts/generate.mjs from icons/outline/devices/driver-refresh.svg, icons/solid/devices/driver-refresh.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function DriverRefresh({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
