/* GENERATED by scripts/generate.mjs from icons/outline/devices/monitor.svg, icons/solid/devices/monitor.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Monitor({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M12 22.7507C11.59 22.7507 11.25 22.4107 11.25 22.0007V17.2207C11.25 16.8107 11.59 16.4707 12 16.4707C12.41 16.4707 12.75 16.8107 12.75 17.2207V22.0007C12.75 22.4107 12.41 22.7507 12 22.7507Z"
        fill="currentColor"
      />
      <path
