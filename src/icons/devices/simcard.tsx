/* GENERATED by scripts/generate.mjs from icons/outline/devices/simcard.svg, icons/solid/devices/simcard.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Simcard({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
