/* GENERATED by scripts/generate.mjs from icons/outline/devices/mobile.svg, icons/solid/devices/mobile.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Mobile({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
