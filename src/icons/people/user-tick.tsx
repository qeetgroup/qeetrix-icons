/* GENERATED from icons/outline/people/user-tick.svg, icons/solid/people/user-tick.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function UserTick({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
