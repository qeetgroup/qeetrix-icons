/* GENERATED by scripts/generate.mjs from icons/outline/people/user-search.svg, icons/solid/people/user-search.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function UserSearch({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M22 22.7495C21.81 22.7495 21.6199 22.6795 21.4699 22.5295L20.4699 21.5295C20.1799 21.2395 20.1799 20.7595 20.4699 20.4695C20.7599 20.1795 21.24 20.1795 21.53 20.4695L22.53 21.4695C22.82 21.7595 22.82 22.2395 22.53 22.5295C22.38 22.6795 22.19 22.7495 22 22.7495Z"
        fill="currentColor"
      />
    </IconBase>
  );
