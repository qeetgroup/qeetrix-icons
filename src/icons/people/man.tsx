/* GENERATED by scripts/generate.mjs from icons/outline/people/man.svg, icons/solid/people/man.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function Man({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M15.9999 8.74945C15.8099 8.74945 15.6199 8.67945 15.4699 8.52945C15.1799 8.23945 15.1799 7.75945 15.4699 7.46945L20.9699 1.96945C21.2599 1.67945 21.7399 1.67945 22.0299 1.96945C22.3199 2.25945 22.3199 2.73945 22.0299 3.02945L16.5299 8.52945C16.3799 8.67945 16.1899 8.74945 15.9999 8.74945Z"
        fill="currentColor"
      />
      <path
