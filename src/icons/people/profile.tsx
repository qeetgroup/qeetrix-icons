/* GENERATED from icons/outline/people/profile.svg, icons/solid/people/profile.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function Profile({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
