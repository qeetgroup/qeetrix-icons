/* GENERATED by scripts/generate.mjs from icons/outline/people/user-square.svg, icons/solid/people/user-square.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function UserSquare({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
