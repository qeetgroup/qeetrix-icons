/* GENERATED from icons/round-outline/people/user-add.svg, icons/round-solid/people/user-add.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function UserAdd({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
        <g clipPath="url(#clip0_3111_32727)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_3111_32706)">
        ...
        <path d="M19.4998 18.7305H16.5098C16.0998 18.7305 15.7598 18.3905 15.7598 17.9805C15.7598 17.5705 16.0998 17.2305 16.5098 17.2305H19.4998C19.9098 17.2305 20.2498 17.5705 20.2498 17.9805C20.2498 18.3905 19.9098 18.7305 19.4998 18.7305Z" fill="currentColor"/>
        <path d="M18 20.2595C17.59 20.2595 17.25 19.9195 17.25 19.5095V16.5195C17.25 16.1095 17.59 15.7695 18 15.7695C18.41 15.7695 18.75 16.1095 18.75 16.5195V19.5095C18.75 19.9295 18.41 20.2595 18 20.2595Z" fill="currentColor"/>
      </g>
      <defs>
        <clipPath id="clip0_3111_32706">
          <rect width="24" height="24" fill="white"/>
        </clipPath>
      </defs>
    </svg>
