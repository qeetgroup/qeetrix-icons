/* GENERATED by scripts/generate.mjs from icons/outline/travel/card-receive.svg, icons/solid/travel/card-receive.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function CardReceive({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M19.9999 10.2504C19.8099 10.2504 19.6199 10.1804 19.4699 10.0304L17.4699 8.03043C17.1799 7.74043 17.1799 7.26043 17.4699 6.97043C17.7599 6.68043 18.2399 6.68043 18.5299 6.97043L20.5299 8.97043C20.8199 9.26043 20.8199 9.74043 20.5299 10.0304C20.3799 10.1804 20.1899 10.2504 19.9999 10.2504Z"
        fill="currentColor"
      />
    </IconBase>
  );
