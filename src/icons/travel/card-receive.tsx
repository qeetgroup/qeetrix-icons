/* GENERATED from icons/round-outline/travel/card-receive.svg, icons/round-solid/travel/card-receive.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function CardReceive({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
