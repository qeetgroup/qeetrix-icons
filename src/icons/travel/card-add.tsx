/* GENERATED by scripts/generate.mjs from icons/outline/travel/card-add.svg, icons/solid/travel/card-add.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function CardAdd({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
