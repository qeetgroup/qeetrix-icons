/* GENERATED from icons/round-outline/travel/card-coin.svg, icons/round-solid/travel/card-coin.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function CardCoin({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
