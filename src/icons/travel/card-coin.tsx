    ...
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g clipPath="url(#clip0_3111_22253)">
          ...
          <path d="M2.5 17.3101C2.22 17.3101 2 17.5301 2 17.8101V18.8101V19.8001C2 21.5601 2.44 22.0001 4.22 22.0001H9.78C11.56 22.0001 12 21.5601 12 19.8001V18.8101V17.8101C12 17.5301 11.78 17.3101 11.5 17.3101H2.5Z" fill="white"/>
          ...
          <path d="M18.5 11C20.9853 11 23 8.98528 23 6.5C23 4.01472 20.9853 2 18.5 2C16.0147 2 14 4.01472 14 6.5C14 8.98528 16.0147 11 18.5 11Z" fill="white"/>
        </g>
        <defs>
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_3111_22251)">
        <path d="M12 17.8101H2C1.59 17.8101 1.25 17.4701 1.25 17.0601C1.25 16.6501 1.59 16.3101 2 16.3101H12C12.41 16.3101 12.75 16.6501 12.75 17.0601C12.75 17.4801 12.41 17.8101 12 17.8101Z" fill="white"/>
        ...
        <path d="M2 9.75C1.59 9.75 1.25 9.41 1.25 9C1.25 4.73 4.73 1.25 9 1.25C9.27 1.25 9.52002 1.4 9.65002 1.63C9.78002 1.87 9.78001 2.15 9.64001 2.39L8.59003 4.14C8.38003 4.49 7.92 4.61 7.56 4.4C7.2 4.19 7.08999 3.73 7.29999 3.37L7.57001 2.92C4.81001 3.57 2.73999 6.05 2.73999 9.01C2.74999 9.41 2.41 9.75 2 9.75Z" fill="white"/>
        <path d="M18.5 11.75C15.61 11.75 13.25 9.4 13.25 6.5C13.25 3.6 15.6 1.25 18.5 1.25C21.4 1.25 23.75 3.6 23.75 6.5C23.75 9.4 21.39 11.75 18.5 11.75ZM18.5 2.75C16.43 2.75 14.75 4.43 14.75 6.5C14.75 8.57 16.43 10.25 18.5 10.25C20.57 10.25 22.25 8.57 22.25 6.5C22.25 4.43 20.57 2.75 18.5 2.75Z" fill="white"/>
      </g>
      <defs>
