/* GENERATED by scripts/generate.mjs from icons/outline/travel/card-tick-alt.svg, icons/solid/travel/card-tick-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function CardTickAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M13.5 4.61039V7.54039C13.5 8.21039 12.96 8.75039 12.29 8.75039H3.21C2.53 8.75039 2 8.19039 2 7.52039C2.01 6.39039 2.46 5.36039 3.21 4.61039C3.96 3.86039 5 3.40039 6.14 3.40039H12.29C12.96 3.40039 13.5 3.94039 13.5 4.61039Z"
          fill="currentColor"
        />
        <path
