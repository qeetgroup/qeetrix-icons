/* GENERATED by scripts/generate.mjs from icons/outline/travel/card-remove-alt.svg, icons/solid/travel/card-remove-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function CardRemoveAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M21.19 8.94023C21 8.94023 20.81 8.87023 20.66 8.72023L16.77 4.83023C16.48 4.54023 16.48 4.06023 16.77 3.77023C17.06 3.48023 17.54 3.48023 17.83 3.77023L21.72 7.66023C22.01 7.95023 22.01 8.43023 21.72 8.72023C21.58 8.87023 21.39 8.94023 21.19 8.94023Z"
        fill="currentColor"
      />
    </IconBase>
  );
