/* GENERATED from icons/round-outline/finance/money-time.svg, icons/round-solid/finance/money-time.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MoneyTime({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_169673)">
        ...
        <path d="M5 22.75C2.38 22.75 0.25 20.62 0.25 18C0.25 15.38 2.38 13.25 5 13.25C7.62 13.25 9.75 15.38 9.75 18C9.75 20.62 7.62 22.75 5 22.75ZM5 14.75C3.21 14.75 1.75 16.21 1.75 18C1.75 19.79 3.21 21.25 5 21.25C6.79 21.25 8.25 19.79 8.25 18C8.25 16.21 6.79 14.75 5 14.75Z" fill="currentColor"/>
