/* GENERATED from icons/round-outline/finance/transaction-minus.svg, icons/round-solid/finance/transaction-minus.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function TransactionMinus({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
