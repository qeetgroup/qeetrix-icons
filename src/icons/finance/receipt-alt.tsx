/* GENERATED by scripts/generate.mjs from icons/outline/finance/receipt-alt.svg, icons/solid/finance/receipt-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ReceiptAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
