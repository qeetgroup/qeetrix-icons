/* GENERATED by scripts/generate.mjs from icons/outline/finance/money-forbidden.svg, icons/solid/finance/money-forbidden.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MoneyForbidden({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M2.24997 21.4995C2.05997 21.4995 1.86994 21.4295 1.71994 21.2795C1.42994 20.9895 1.42994 20.5095 1.71994 20.2195L7.21994 14.7195C7.50994 14.4295 7.99 14.4295 8.28 14.7195C8.57 15.0095 8.57 15.4895 8.28 15.7795L2.78 21.2795C2.63 21.4295 2.43997 21.4995 2.24997 21.4995Z"
        fill="currentColor"
      />
    </IconBase>
  );
