/* GENERATED from icons/outline/finance/receipt-square.svg, icons/solid/finance/receipt-square.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ReceiptSquare({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
