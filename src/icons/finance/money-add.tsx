/* GENERATED by scripts/generate.mjs from icons/outline/finance/money-add.svg, icons/solid/finance/money-add.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function MoneyAdd({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
