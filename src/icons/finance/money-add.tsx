/* GENERATED from icons/round-outline/finance/money-add.svg, icons/round-solid/finance/money-add.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MoneyAdd({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_169658)">
        ...
        <path d="M6.49976 18.7305H3.50977C3.09977 18.7305 2.75977 18.3905 2.75977 17.9805C2.75977 17.5705 3.09977 17.2305 3.50977 17.2305H6.49976C6.90976 17.2305 7.24976 17.5705 7.24976 17.9805C7.24976 18.3905 6.90976 18.7305 6.49976 18.7305Z" fill="currentColor"/>
        <path d="M5 20.2595C4.59 20.2595 4.25 19.9195 4.25 19.5095V16.5195C4.25 16.1095 4.59 15.7695 5 15.7695C5.41 15.7695 5.75 16.1095 5.75 16.5195V19.5095C5.75 19.9295 5.41 20.2595 5 20.2595Z" fill="currentColor"/>
