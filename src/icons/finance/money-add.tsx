/* GENERATED from icons/outline/finance/money-add.svg, icons/solid/finance/money-add.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MoneyAdd({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g clipPath="url(#clip0_4418_169736)">
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_4418_169658)">
        ...
        <path d="M5 22.75C3.34 22.75 1.78 21.87 0.940002 20.44C0.490002 19.72 0.25 18.87 0.25 18C0.25 15.38 2.38 13.25 5 13.25C7.62 13.25 9.75 15.38 9.75 18C9.75 18.87 9.51 19.72 9.06 20.45C8.22 21.87 6.66 22.75 5 22.75ZM5 14.75C3.21 14.75 1.75 16.21 1.75 18C1.75 18.59 1.91 19.17 2.22 19.67C2.8 20.65 3.87 21.25 5 21.25C6.13 21.25 7.2 20.65 7.78 19.68C8.09 19.17 8.25 18.6 8.25 18C8.25 16.21 6.79 14.75 5 14.75Z" fill="white"/>
        <path d="M6.49976 18.7305H3.50977C3.09977 18.7305 2.75977 18.3905 2.75977 17.9805C2.75977 17.5705 3.09977 17.2305 3.50977 17.2305H6.49976C6.90976 17.2305 7.24976 17.5705 7.24976 17.9805C7.24976 18.3905 6.90976 18.7305 6.49976 18.7305Z" fill="white"/>
        <path d="M5 20.2595C4.59 20.2595 4.25 19.9195 4.25 19.5095V16.5195C4.25 16.1095 4.59 15.7695 5 15.7695C5.41 15.7695 5.75 16.1095 5.75 16.5195V19.5095C5.75 19.9295 5.41 20.2595 5 20.2595Z" fill="white"/>
