/* GENERATED from icons/round-outline/finance/receipt-list-alt.svg, icons/round-solid/finance/receipt-list-alt.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ReceiptListAlt({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" {...props}>
      <g clipPath="url(#clip0_4418_169700)">
        ...
        <path d="M16.23 11.75H10.73C10.32 11.75 9.97998 11.41 9.97998 11C9.97998 10.59 10.32 10.25 10.73 10.25H16.23C16.64 10.25 16.98 10.59 16.98 11C16.98 11.41 16.64 11.75 16.23 11.75Z" fill="currentColor"/>
        <path d="M16.23 7.75H10.73C10.32 7.75 9.97998 7.41 9.97998 7C9.97998 6.59 10.32 6.25 10.73 6.25H16.23C16.64 6.25 16.98 6.59 16.98 7C16.98 7.41 16.64 7.75 16.23 7.75Z" fill="currentColor"/>
        <path d="M7.78003 8C7.23003 8 6.78003 7.55 6.78003 7C6.78003 6.45 7.23003 6 7.78003 6C8.33003 6 8.78003 6.45 8.78003 7C8.78003 7.55 8.33003 8 7.78003 8Z" fill="currentColor"/>
        <path d="M7.78003 12C7.23003 12 6.78003 11.55 6.78003 11C6.78003 10.45 7.23003 10 7.78003 10C8.33003 10 8.78003 10.45 8.78003 11C8.78003 11.55 8.33003 12 7.78003 12Z" fill="currentColor"/>
      </g>
      <defs>
