/* GENERATED from icons/round-outline/finance/money-tick.svg, icons/round-solid/finance/money-tick.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function MoneyTick({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
