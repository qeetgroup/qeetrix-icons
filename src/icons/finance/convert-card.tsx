/* GENERATED from icons/outline/finance/convert-card.svg, icons/solid/finance/convert-card.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ConvertCard({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
