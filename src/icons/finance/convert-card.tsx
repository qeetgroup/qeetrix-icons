/* GENERATED by scripts/generate.mjs from icons/outline/finance/convert-card.svg, icons/solid/finance/convert-card.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ConvertCard({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
      <IconBase variant={variant} {...props}>
        ...
        />
        <path
          d="M12.5 5.80957C12.22 5.80957 12 6.02957 12 6.30957V7.30957V8.29957C12 10.0596 12.44 10.4996 14.22 10.4996H19.78C21.56 10.4996 22 10.0596 22 8.29957V7.30957V6.30957C22 6.02957 21.78 5.80957 21.5 5.80957H12.5Z"
          fill="currentColor"
        />
        <path
        ...
        />
        <path
          d="M2.5 17.3096C2.22 17.3096 2 17.5296 2 17.8096V18.8096V19.7996C2 21.5596 2.44 21.9996 4.22 21.9996H9.78C11.56 21.9996 12 21.5596 12 19.7996V18.8096V17.8096C12 17.5296 11.78 17.3096 11.5 17.3096H2.5Z"
          fill="currentColor"
        />
      </IconBase>
    );
  ...
  return (
    <IconBase variant={variant} {...props}>
      <path
        d="M22 6.30957H12C11.59 6.30957 11.25 5.96957 11.25 5.55957C11.25 5.14957 11.59 4.80957 12 4.80957H22C22.41 4.80957 22.75 5.14957 22.75 5.55957C22.75 5.97957 22.41 6.30957 22 6.30957Z"
        fill="currentColor"
      />
      <path
