/* GENERATED from icons/round-outline/finance/receipt-discount-alt.svg, icons/round-solid/finance/receipt-discount-alt.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ReceiptDiscountAlt({ variant = "outline", shape: _shape = "round", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid"; shape?: "round" }) {
  if (variant === "solid") {
    return (
