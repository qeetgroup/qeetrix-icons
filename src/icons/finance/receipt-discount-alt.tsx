/* GENERATED by scripts/generate.mjs from icons/outline/finance/receipt-discount-alt.svg, icons/solid/finance/receipt-discount-alt.svg. Do not edit by hand. */
import { IconBase } from "../../icon-base.js";
import type { QeetrixIconProps } from "../../types.js";

export function ReceiptDiscountAlt({ variant = "outline", ...props }: QeetrixIconProps & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
  ...
  return (
    <IconBase variant={variant} {...props}>
      ...
      />
      <path
        d="M8.63007 14.5498C8.44007 14.5498 8.25007 14.4798 8.10007 14.3298C7.81007 14.0398 7.81007 13.5598 8.10007 13.2698L14.8301 6.53977C15.1201 6.24977 15.6001 6.24977 15.8901 6.53977C16.1801 6.82977 16.1801 7.30977 15.8901 7.59977L9.16007 14.3298C9.02007 14.4798 8.83007 14.5498 8.63007 14.5498Z"
        fill="currentColor"
      />
    </IconBase>
  );
