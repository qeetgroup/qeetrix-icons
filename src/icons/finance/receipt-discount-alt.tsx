...
export function ReceiptDiscountAlt({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clipPath="url(#clip0_4418_169701)">
        ...
        <path d="M8.63007 14.5498C8.44007 14.5498 8.25007 14.4798 8.10007 14.3298C7.81007 14.0398 7.81007 13.5598 8.10007 13.2698L14.8301 6.53977C15.1201 6.24977 15.6001 6.24977 15.8901 6.53977C16.1801 6.82977 16.1801 7.30977 15.8901 7.59977L9.16007 14.3298C9.02007 14.4798 8.83007 14.5498 8.63007 14.5498Z" fill="white"/>
      </g>
      <defs>
        <clipPath id="clip0_4418_169701">
          <rect width="24" height="24" fill="white"/>
        </clipPath>
      </defs>
    </svg>
