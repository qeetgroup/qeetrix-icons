/* GENERATED from icons/outline/finance/receipt-search.svg, icons/solid/finance/receipt-search.svg by scripts/generate.mjs. Do not edit by hand. */
import type { SVGProps } from "react";

export function ReceiptSearch({ variant = "outline", ...props }: SVGProps<SVGSVGElement> & { variant?: "outline" | "solid" }) {
  if (variant === "solid") {
    return (
